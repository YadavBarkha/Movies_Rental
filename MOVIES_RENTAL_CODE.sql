...
-- provide a list of top 10 customers based on revenue to push offers to them
...
FROM
    PAYMENT AS P
        LEFT JOIN
    RENTAL AS R ON P.PAYMENT_ID = R.RENTAL_ID
        LEFT JOIN
...
FROM PAYMENT
WHERE CUSTOMER_ID < 101 AND AMOUNT > 5 AND PAYMENT_DATE  >'2006-01-1';
